...
router.get('/api/getAllComments', commentController.getAllComments);
router.get('/api/getComment/:id', commentController.getCommentById);
router.put('/api/updateComment/:id', commentController.updateComment);
